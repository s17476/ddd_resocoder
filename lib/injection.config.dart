...
import 'package:ddd_resocoder/application/auth/auth_bloc.dart' as _i13;
...
import 'package:ddd_resocoder/domain/notes/i_note_repository.dart' as _i7;
import 'package:ddd_resocoder/infrastructure/auth/firebase_auth_facade.dart'
    as _i6;
import 'package:ddd_resocoder/infrastructure/notes/note_repository.dart' as _i8;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i7.INoteRepository>(
      () => _i8.Noterepository(firebaseFirestore: gh<_i9.FirebaseFirestore>()));
  ...
  gh.factory<_i12.SignInFormBloc>(
      () => _i12.SignInFormBloc(authFacade: gh<_i5.IAuthFacade>()));
  gh.factory<_i13.AuthBloc>(
      () => _i13.AuthBloc(iAuthFacade: gh<_i5.IAuthFacade>()));
  return getIt;
}
